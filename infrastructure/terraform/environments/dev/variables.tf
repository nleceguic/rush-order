...
variable "stripe_key"               { type = string; sensitive = true; default = "sk_test_placeholder" }
...
variable "docker_registry_password" { type = string; sensitive = true; default = "placeholder" }
variable "docker_image"             { type = string; default = "rushorderacr.azurecr.io/rush-order-api:latest" }
